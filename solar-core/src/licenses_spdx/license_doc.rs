pub const LICENSE_DOC: &str = "
      ...
      ACE(TM), TAO(TM), CIAO(TM), DAnCE>(TM), and CoSMIC(TM) (henceforth referred to as \"DOC software\") are
         ...
         California, Irvine, and Vanderbilt University,  Copyright (c) 1993-2009, all rights reserved. Since DOC
      ...
      The ACE, TAO, CIAO, DAnCE, and CoSMIC web sites are maintained by the DOC Group at the Institute for
      ...
      DOC software is provided with no support and without any obligation on the part of Washington University,
         ...
         as they upgrade their operating systems accordingly.
