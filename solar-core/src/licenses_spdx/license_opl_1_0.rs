...
Version 1.0
      ...
      This license is a union of the following two parts that should be found as text files
              ...
              The contents of this file OPL_1_0.TXT, stating the general licensing policy of the software.
                  ...
                  In case of conflicting dispositions in the parts of this license, the terms of the
      ...
      This License and the rights granted hereunder will terminate automatically if You fail
          ...
          The Covered Code is a ``commercial item,'' as that term is defined in 48 C.F.R. 2.101
             ...
             11.
          MISCELLANEOUS.
          his section was intentionally left blank. The contents of this section are found in the
      ...
      Except in cases where another Contributor has failed to comply with Section 3.4, You are responsible for
         ...
         Text for this Exhibit A is found in the corresponding addendum, described in section 6.4 above, text file
         provided by the Initial Developer. This license is not valid or complete with out that file.

         EXHIBIT B.

         Text for this Exhibit B is found in the corresponding addendum, described in section 6.4 above, text file
         provided by the Initial Developer. This license is not valid or complete with out that file.
