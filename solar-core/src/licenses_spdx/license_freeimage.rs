pub const LICENSE_FREEIMAGE: &str = "
      ...
      The Initial Developer hereby grants You a world-wide, royalty-free, non-exclusive
                  ...
                  under patents now or hereafter owned or controlled by Initial Developer, to make, have
                     made, use and sell (\"Utilize\") the Original Code (or portions thereof), but
   ...
   This License applies to code to which the Initial Developer has attached the notice in
      ...
      Floris van den Berg may publish revised and/or new versions of the License from time to
      ...
      No one other than Floris van den Berg has the right to modify the terms applicable to
      ...
      If you create or use a modified version of this License (which you may only do in order
                     ...
                     you must (a) rename Your license so that the phrases \"FreeImage\",
                     `FreeImage Public License\", \"FIPL\", or any confusingly similar
                     phrase do not appear anywhere in your license and (b) otherwise make it clear that
                     your version of the license contains terms which differ from the FreeImage Public
   ...
   This License represents the complete agreement concerning subject matter hereof. If any
                 ...
                 governed by Dutch law provisions (except to the extent applicable law, if any,
                 ...
                 registered to do business in, the The Netherlands: (a) unless otherwise agreed in
                 writing, all disputes relating to this License (excepting any dispute relating to
                 intellectual property rights) shall be subject to final and binding arbitration, with
                 the losing party paying all costs of arbitration; (b) any arbitration relating to this
                 Agreement shall be held in Almelo, The Netherlands; and (c) any litigation relating to
                 this Agreement shall be subject to the jurisdiction of the court of Almelo, The
                 Netherlands with the losing party responsible for costs, including without limitation,
                 court costs and reasonable attorneys fees and expenses. Any law or regulation which
   ...
   Except in cases where another Contributor has failed to comply with Section 3.4, You are responsible for
         ...
         a copy of the License at http://home.wxs.nl/~flvdberg/freeimage-license.txt
