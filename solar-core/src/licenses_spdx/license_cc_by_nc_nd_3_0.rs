pub const LICENSE_CC_BY_NC_ND_3_0: &str = "
         ...
         RIGHTS CONTAINED HERE IN CONSIDERATION OF YOUR ACCEPTANCE OF SUCH TERMS AND CONDITIONS.
          ...
          License Grant. Subject to the terms and conditions of this License, Licensor hereby grants You a
            ...
            The above rights may be exercised in all media and formats whether now known or hereafter
               ...
               rights to make Adaptations. Subject to 8(f), all rights not expressly granted by Licensor
               are hereby reserved, including but not limited to the rights set forth in Section
               4(d).
          ...
          Restrictions. The license granted in Section 3 above is expressly made subject to and limited by
            ...
            If You Distribute, or Publicly Perform the Work or Collections, You must, unless a request
               ...
               appropriate, of You or Your use of the Work, without the separate, express prior written
