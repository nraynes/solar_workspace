pub const LICENSE_BARR: &str = "
      
      This is a package of commutative diagram macros built on top of Xy-pic by Michael Barr (email:
         ...
         Plain TeX. Although I know of no reason it will not work with AMSTeX, I have not tested it.
