pub const LICENSE_CC_BY_SA_2_0: &str = "
         ...
         TERMS AND CONDITIONS.
          ...
          Restrictions. The license granted in Section 3 above is expressly made subject to and limited by
            ...
            You may distribute, publicly display, publicly perform, or publicly digitally perform a
               ...
               contains the same License Elements as this License (e.g. Attribution-ShareAlike 2.0
          ...
          UNLESS OTHERWISE AGREED TO BY THE PARTIES IN WRITING, LICENSOR OFFERS THE WORK AS-IS AND MAKES NO
             REPRESENTATIONS OR WARRANTIES OF ANY KIND CONCERNING THE MATERIALS, EXPRESS, IMPLIED,
