pub const LICENSE_XEROX: &str = "
      ...
      Use and copying of this software and preparation of derivative works based upon this software are
         ...
         derivative works must comply with all applicable United States export control laws.

      This software is made available AS IS, and XEROX CORPORATION DISCLAIMS ALL WARRANTIES, EXPRESS OR
