pub const LICENSE_LILIQ_R_1_1: &str = "
   ...
   Sous réserve des termes de la licence, le concédant
                 ...
                 logiciel :
                   ...
                   2  Exécuter ou représenter la totalité ou une partie
   ...
   Le licencié peut distribuer des copies du logiciel,
                 ...
                 de respecter les conditions suivantes :
                   ...
                   1  Le logiciel doit être accompagné d'un exemplaire de
             cette licence;
               

                   2  Si le logiciel a été modifié, le licencié doit en
                 faire la mention, de préférence dans chacun
                 des fichiers modifiés dont la nature permet
                 une telle mention;
               

                   3  Les étiquettes ou mentions faisant état des
   ...
   Chaque fois que le licencié distribue le logiciel,
          ...
          Chaque fois que le licencié distribue le logiciel ou un
   ...
   Dans la mesure où le licencié souhaite distribuer
          ...
          Un licencié qui est titulaire exclusif du droit d'auteur
            ...
            Est considérée comme une licence compatible toute licence
             ...
             notamment :
                   ...
                   3  Contrat de licence de logiciel libre CeCILL,
                 version 2.1 (CECILL-2.1)
                   ...
                   7  Licence Libre du Québec – Réciprocité forte
                 version 1.1 (LiLiQ-R+ 1.1)
   ...
   Le licencié est responsable de tout préjudice
          ...
          Le concédant ne saurait être tenu responsable du
