pub const LICENSE_PSF_2_0: &str = "
	  ...
	  Subject to the terms and conditions of this License Agreement,  PSF hereby  grants Licensee
          ...
          2001, 2002, 2003, 2004, 2005, 2006 Python Software Foundation All Rights Reserved\" are retained in  Python alone or in any
          ...
          changes made to  Python.
           ...
           4.
	   PSF is making  Python
	  available to Licensee on an \"AS IS\" basis.  PSF  MAKES NO
