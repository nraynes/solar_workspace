...
Copyright (c) 1989-2001 by Lucent Technologies
      ...
      Permission to use, copy, modify, and distribute this software and its documentation for any purpose and
         ...
         name of Lucent Technologies, Bell Labs or any Lucent entity not be used in
       ...
       Lucent disclaims all
         ...
         merchantability and fitness. In no event shall  Lucent be
