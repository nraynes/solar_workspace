pub const LICENSE_W3C: &str = "
      ...
      Notice of any changes or modifications to the files, including the date changes were made. (We recommend
      ...
      The name and trademarks of copyright holders may NOT be used in advertising or publicity pertaining to
         ...
         the W3C, reflects that ERCIM is now a host of the W3C, includes references to this specific dated
         version of the license, and removes the ambiguous grant of \"use\". Otherwise, this version is the same
    ...
    University). All Rights Reserved.
         This work is distributed under the W3C® Software License in the hope that it will be useful, but WITHOUT ANY
