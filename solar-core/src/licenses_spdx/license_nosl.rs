...
Version 1.0
      ...
      You may distribute Covered Code in Executable form only if the requirements of Section
                     ...
                     the Executable version of Covered Code or ownership rights under a license of Your
      ...
      You may create a Larger Work by combining Covered Code with other code not governed by
                     the terms of this License and distribute the Larger Work as a single  LEDs product.
      ...
      Once Covered Code has been published under a particular version of the License, You may
                     ...
                     published by Netizen. No one other than Netizen has the right to modify the terms
      ...
      If You create or use a modified version of this License (which you may only do in order
                     ...
                     You must (a) rename Your license so that the phrases \"Netizen\",
                     \"NOSL\" or any confusingly similar phrase do not appear in your license
                     ...
                     the Netizen Open Source License and Xen Open Source License. (Filling in the name
          ...
          COVERED CODE IS PROVIDED UNDER THIS LICENSE ON AN \"AS IS\" BASIS, WITHOUT WARRANTY OF
             ...
             AUTHORIZED HEREUNDER EXCEPT UNDER THIS DISCLAIMER.
                  ...
                  7.1
                 To the extent permitted by law and except as expressly provided to the contrary in this
                    Agreement, all warranties whether express, implied, statutory or otherwise, relating in
                    any way to the subject matter of this Agreement or to this Agreement generally, are
                    excluded. Where legislation implies in this Agreement any condition or warranty and that
                    legislation avoids or prohibits provisions in a contract excluding or modifying the
                    application of or the exercise of or liability under such term, such term shall be deemed
                    to be included in this Agreement. However, the liability of Supplier for any breach of
                    such term shall be limited, at the option of Supplier, to any one or more of the
                    following: if the breach related to goods: the replacement of the goods or the supply of
                    equivalent goods; the repair of such goods; the payment of the cost of replacing the goods
                    or of acquiring equivalent goods; or the payment of the cost of having the goods repaired;
                    and if the breach relates to services the supplying of the services again; or the payment
   ...
   This Agreement shall be governed by and construed according to the law of the State of
                 Victoria. The parties irrevocably submit to the exclusive jurisdiction of the Courts
                 of Victoria and Australia and any Courts hearing appeals from such Courts. This
                 Agreement is deemed to have been made in Victoria.
   ...
   The application of the United Nations Convention on Contracts for the International Sale of
         ...
         ``The contents of this file are subject to the Netizen Open Source License Version 1.0 (the
       \"License\"); you may not use this file except in compliance with the License. You may obtain
       a copy of the License at http://netizen.com.au/licenses/NOPL/
       ...
       License and not to allow others to use your version of this file under the NOSL, indicate your
       ...
       version of this file under either the NOSL or the [___] License.\"
