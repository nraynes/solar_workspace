pub const LICENSE_CPAL_1_0: &str = "
         ...
         Common Public Attribution License Version 1.0 (CPAL)
          ...
          \"Definitions\"
              ...
              \"Modifications\" means any addition to or deletion from the substance or structure
                 of either the Original Code or any previous Modifications. When Covered Code is released as a
              ...
              \"You\" (or \"Your\") means an individual or a legal entity exercising
                 rights under, and complying with all of the terms of, this License or a future version of this
      ...
      The Modifications which You create or to which You contribute are governed by the terms of
                     ...
                     Covered Code may be distributed only under the terms of this License or a future
                     version of this License released under Section 6.1, and You must include a copy of
                     this License with every copy of the Source Code You distribute. You may not offer or
      ...
      You must duplicate the notice in Exhibit A in each file of the Source Code. If it is not
                     ...
                     then You must include such notice in a location (such as a relevant directory) where a
                     ...
                     the Initial Developer or such Contributor as a result of warranty, support, indemnity
      ...
      You may distribute Covered Code in Executable form only if the requirements of Section
                     ...
                     Executable version under a different license You must make it absolutely clear that
      ...
      You may create a Larger Work by combining Covered Code with other code not governed by the
                     ...
                     case, You must make sure the requirements of this License are fulfilled for the
                     Covered Code.
   ...
   This License applies to code to which the Initial Developer has attached the notice in
      ...
      Socialtext, Inc. (\"Socialtext\") may publish revised and/or new versions of
                     the License from time to time. Each version will be given a distinguishing version
                     number.
      ...
      Once Covered Code has been published under a particular version of the License, You may
                     ...
                     by Socialtext. No one other than Socialtext has the right to modify the terms
      ...
      If You create or use a modified version of this License (which you may only do in order to
                     ...
                     (a) rename Your license so that the phrases \"Socialtext\",
                     \"CPAL\" or any confusingly similar phrase do not appear in your license
                     (except to note that your license differs from this License) and (b) otherwise make it
                     clear that Your version of the license contains terms which differ from the CPAL.
   ...
   COVERED CODE IS PROVIDED UNDER THIS LICENSE ON AN \"AS IS\" BASIS, WITHOUT
                 ...
                 IN ANY RESPECT, YOU (NOT THE INITIAL DEVELOPER, ORIGINAL DEVELOPER OR ANY OTHER
          ...
          TERMINATION.
              ...
              If You initiate litigation by asserting a patent infringement claim (excluding declatory judgment
                 actions) against Initial Developer, Original Developer or a Contributor (the Initial
   ...
   UNDER NO CIRCUMSTANCES AND UNDER NO LEGAL THEORY, WHETHER TORT (INCLUDING NEGLIGENCE),
                 CONTRACT, OR OTHERWISE, SHALL YOU, THE INITIAL DEVELOPER, ORIGINAL DEVELOPER, ANY
   ...
   As between Initial Developer, Original Developer and the Contributors, each party is
                 ...
                 Original Developer and Contributors to distribute such responsibility on an equitable
   ...
   Initial Developer may designate portions of the Covered Code as Multiple-Licensed.
          ...
          ADDITIONAL TERM: ATTRIBUTION
                   ...
                   (a)
              As a modest attribution to the organizer of the development of the Original Code
                 (\"Original Developer\"), in the hope that its promotional value may help
                 justify the time, money and effort invested in writing the Original Code, the Original
                 Developer may include in Exhibit B (\"Attribution Information\") a requirement
                 that each time an Executable and Source Code or a Larger Work is launched or initially run
                 (which includes initiating a session), a prominent display of the Original
                 Developer's Attribution Information (as defined below) must occur on the graphic
                 user interface employed by the end user to access such Covered Code (which may include
                 display on a splash screen), if any. The size of the graphic image should be consistent
                 with the size of the other elements of the Attribution Information. If the access by the
                 end user to the Executable and Source Code does not create a graphic user interface for
                 access to the Covered Code, this obligation shall not apply. If the Original Code displays
                 such Attribution Information in a particular form (such as in the form of a splash screen,
                 notice at login, an \"about\" display, or dedicated attribution area on user
                 interface screens), continued use of such form for that Attribution Information is one way
                 of meeting this requirement for notice.
            
               

                   (b)
              Attribution information may only include a copyright notice, a brief phrase, graphic image
                 and a URL (\"Attribution Information\") and is subject to the Attribution
                 ...
                 word or one phrase (not exceeding 10 words); (c) one graphic image provided by the
                 ...
                 Limits\").
                   ...
                   (c)
              If Exhibit B does not include any Attribution Information, then there are no requirements for
                 You to display any Attribution Information of the Original Developer.
            
               

                   (d)
              You acknowledge that all trademarks, service marks and/or trade names contained within the
                 Attribution Information distributed with the Covered Code are the exclusive property of
                 their owners and may only be used with the permission of their owners, or under
          ...
          The term \"External Deployment\" means the use, distribution, or communication of the
             Original Code or Modifications in any way such that the Original Code or Modifications may be used by
             anyone other than You, whether those works are distributed or communicated to those persons or made
             available as an application intended for use over a network. As an express condition for the grants of
             license hereunder, You must treat any External Deployment by You of the Original Code or Modifications
...
Display of Attribution Information is [required/not required] in Larger Works which are defined in
             the CPAL as a work which combines Covered Code or portions thereof with code not governed by
