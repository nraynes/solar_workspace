pub const LICENSE_NPL_1_1: &str = "
      ...
      The Netscape Public License Version 1.1 (\"NPL\") consists of the Mozilla Public License Version 1.1 with
         the following Amendments, including Exhibit A-Netscape Public License. Files identified with \"Exhibit
         A-Netscape Public License\" are governed by the Netscape Public License Version 1.1.
   ...
   These additional terms described in this Netscape Public License -- Amendments shall
             ...
             II.
          \"Netscape's Branded Code\" means Covered Code that Netscape distributes and/or permits others
             to distribute under one or more trademark(s) which are controlled by Netscape but which
   ...
   This License does not grant any rights to use the trademarks \"Netscape\", the \"Netscape
                 N and horizon\" logo or the \"Netscape lighthouse\" logo, \"Netcenter\", \"Gecko\",
                 \"Java\" or \"JavaScript\", \"Smart Browsing\" even if such marks are included in the
...
Contributor(s): ______________________________________.
      ...
      Alternatively, the contents of this file may be used under the terms of the _____ license
         ...
         under the NPL, indicate your decision by deleting the provisions above and replace them
         with the notice and other provisions required by the [___] License. If you do not delete
         the provisions above, a recipient may use your version of this file under either the NPL
         or the [___] License.\"
          ...
          1.0.1. \"Commercial Use\" means distribution or otherwise making the Covered Code available to a
             third party.
              ...
              \"Contributor\" means each entity that creates or contributes to the creation of Modifications.
                   ...
                   1.2.
              \"Contributor Version\" means the combination of the Original Code, prior Modifications used by
      ...
      Any new file that contains any part of the Original Code or previous Modifications.
         ...
         Contributor represents that, except as disclosed pursuant to Section 3.4 (a) above,
              ...
              Required Notices. You must duplicate the notice in Exhibit A in each file of the Source Code.
                 ...
                 describe recipients' rights or ownership rights relating to Covered Code. You may choose
                 to offer, and to charge a fee for, warranty, support, indemnity or liability obligations
   ...
   This License applies to code to which the Initial Developer has attached the notice in
      ...
      If You create or use a modified version of this License (which you may only do in order
                     ...
                     in your license (except to note that your license differs from this License) and
                     (b) otherwise make it clear that Your version of the license contains terms which
              ...
              If You initiate litigation by asserting a patent infringement claim (excluding declatory
                 ...
                 that:
                  ...
                  such Participant's Contributor Version directly or indirectly infringes any patent, then
                     ...
                     this License shall, upon 60 days notice from Participant terminate prospectively,
   ...
   The Covered Code is a \"commercial item,\" as that term is defined in 48 C.F.R. 2.101 (Oct.
                 ...
                 U.S. Government End Users acquire Covered Code with only those rights set forth
                 herein.
