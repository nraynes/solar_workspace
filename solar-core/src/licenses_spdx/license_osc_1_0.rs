pub const LICENSE_OSC_1_0: &str = "
		...
		gestellt wird, dies unter den folgenden Bedingungen zu gestatten:

		Der obige Urheberrechtshinweis und dieser Genehmigungshinweis müssen in allen Kopien
		oder wesentlichen Teilen der Software enthalten sein.

		DIE URHEBER ODER URHEBERRECHTSINHABER HAFTEN UNBESCHRÄNKT BEI VORSATZ, ARGLISTIGER
		...
		DEN SCHADEN, DER BEI VERTRAGSSCHLUSS VORHERSEHBAR UND TYPISCH IST.

		DARÜBER HINAUS IST EINE HAFTUNG AUSGESCHLOSSEN.

		DIE VORSTEHENDE HAFTUNGSBESCHRÄNKUNG GILT AUCH FÜR DIE HAFTUNG DER MITARBEITER, VERTRETER
		UND ORGANE DER URHEBER ODER URHEBERRECHTSINHABER.
