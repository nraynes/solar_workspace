pub const LICENSE_SIMPL_2_0: &str = "
         ...
         This Simple Public License 2.0 (SimPL 2.0 for short) is a plain language implementation of GPL 2.0. The
      ...
      The SimPL applies to the software's source and object code and comes with any rights that I have in it
         (other than trademarks). You agree to the SimPL by copying, distributing, or making a derivative work
         of the software.
      ...
      You may do anything that you want with the SimPL text; it's a license form to use in any way that you
