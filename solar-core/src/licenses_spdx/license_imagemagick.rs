pub const LICENSE_IMAGEMAGICK: &str = "
      ...
      The legally binding and authoritative terms and conditions for use, reproduction, and distribution of
         ...
         Copyright 1999-2013 ImageMagick Studio LLC, a non-profit organization dedicated to making software
         imaging solutions freely available.
          ...
          Redistribution. You may reproduce and distribute copies of the Work or Derivative Works thereof
            ...
            If the Work includes a \"NOTICE\" text file as part of its distribution, then any Derivative
               ...
               of the Derivative Works, in at least one of the following places: within a NOTICE text
               ...
               of the NOTICE file are for informational purposes only and do not modify the License. You
         ...
         Licensed under the ImageMagick License (the \"License\"); you may not use this file except in compliance
