pub const LICENSE_CC_BY_ND_2_5: &str = "
         ...
         TERMS AND CONDITIONS.
          ...
          Restrictions. The license granted in Section 3 above is expressly made subject to and limited by
            ...
            If you distribute, publicly display, publicly perform, or publicly digitally perform the Work
               ...
               (or pseudonym, if applicable) if supplied, and/or (ii) if the Original Author and/or
               ...
               reasonable means, the name of such party or parties; the title of the Work if supplied;
               and to the extent reasonably practicable, the Uniform Resource Identifier, if any, that
               Licensor specifies to be associated with the Work, unless such URI does not refer to the
               copyright notice or licensing information for the Work. Such credit may be implemented in
               any reasonable manner; provided, however, that in the case of a Collective Work, at a
          ...
          Miscellaneous
                   ...
                   a.
            Each time You distribute or publicly digitally perform the Work, the Licensor offers to the
