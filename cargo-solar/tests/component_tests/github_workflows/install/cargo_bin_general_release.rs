...
use solar_core::{
    components::github_workflows::{
        ...
        workflow::{CargoBinGeneralRelease, Workflow},
    },
...
static WORKFLOW_BEING_TESTED: &str = "cargo-bin-general-release";
...
pub fn cold_hot() {
    ...
    let expected_workflow = Workflow::CargoBinGeneralRelease(CargoBinGeneralRelease::new(
