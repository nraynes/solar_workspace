...
use solar_core::{
    components::github_workflows::{
        ...
        workflow::{CargoAnyGeneralTest, Workflow},
    },
...
static WORKFLOW_BEING_TESTED: &str = "cargo-any-general-test";
...
pub fn cold_hot() {
    ...
    let expected_workflow = Workflow::CargoAnyGeneralTest(CargoAnyGeneralTest::new(
        "CI/CD Test".to_string(),
        "master".to_string(),
    ));
